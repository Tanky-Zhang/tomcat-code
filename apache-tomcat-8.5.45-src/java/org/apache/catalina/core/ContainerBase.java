...
public abstract class ContainerBase extends LifecycleMBeanBase
    ...
    protected void initInternal() throws LifecycleException {
        //猜测：由于Engine下有多个Host，Host下有多个Context，Context下有多个Wrapper所以
        //所有继承自本类的类在进行父类的该方法调用时都要初始化一个线程池保证程序的异步执行
        //创建一个队列
     ...
     *
     *  所有继承ContainerBase的组件-- Engine Host Context Wrapper
     *  都调用了父类的startInternal方法从而启动了各自的子组件
     */
    @Override
    ...
    private static class StartChild implements Callable<Void> {
        ...
        public Void call() throws LifecycleException {
            //真正执行每个子组件的启动 调用子组件的startInternal 巧妙 牛逼！！！！！妙啊！！！！
            child.start();
            return null;
        }
    }
