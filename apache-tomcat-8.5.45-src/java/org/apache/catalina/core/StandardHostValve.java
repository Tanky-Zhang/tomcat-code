 ...
 * (the "License"); you may not use this file except in compliance(合规) with
 * the License(许可).  You may obtain a copy of the License at
 *
    ...
    public final void invoke(Request request, Response response)
        ...
        try {
            ...
            if (!asyncAtStart && !context.fireRequestInitEvent(request.getRequest())) {
                ...
                // is aborted.
                /**
                 * 请勿在异步处理期间触发侦听器（侦听器会为调用startAsync（）的请求触发）。如果请求初始化侦听器引发异常，则该请求将中止。
                 */
                return;
            }
            ...
            /**
             * 要求此上下文处理此请求。必须将已经出错的请求路由到此处，以检查应用程序定义的错误页面，因此请勿将它们转发给应用程序进行处理。
             */
            try {
            ...
            //现在，请求/响应对返回到容器控制之下，抬起悬架，以便完成错误处理和/或容器可以刷新所有剩余数据
