...
public class StringManager {
    ...
    public String getString(final String key, final Object... args) {
        //kry:"lifecycleBase.invalidTransition"  args:null
        //value=OS Version:            {0}
        //getString()方法获取到的是这个包下边的这个键对应的值例如：ExtensionValidator[{0}][{1}]: La extensión no encuentra el [{2}] requerido.
        //这个键带着数字0，1，2等占位符
     ...
     * StringManager是包级单例的所以要判断在这个包中有没有被实例化
     */
